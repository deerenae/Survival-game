...
t5 = Tool.create(name: "Hand Sanitizer", rating: 5, image: "https://images.uline.com/is/image//content/dam/images/S/S20500/S-20117.jpg?$Mobile_SI$&iccEmbed=1&icc=AdobeRGB")
...
s1 = Shelter.create(name: "Quarantine House", rating: 7, image: "https://i.guim.co.uk/img/media/e03ade5f1a1f7ed8966d18f0ae8e0d2be9ca97e6/0_0_5315_3191/master/5315.jpg?width=1920&quality=85&auto=format&fit=max&s=0e30b8c58e10333b7b7ad7a72363403c")
s1 = Shelter.create(name: "Cave", rating: 8, image: "http://nebula.wsimg.com/570f41e6a7f4ffc297640e1fb4449a80?AccessKeyId=1D367233EC437D722752&disposition=0&alloworigin=1")
s1 = Shelter.create(name: "Igloo", rating: 8, image: "https://nativeamericansofthearctic.weebly.com/uploads/4/2/6/6/42667725/2664211.jpg?492")
s1 = Shelter.create(name: "Tree", rating: 4, image: "https://mysurvivalforum.com/attachments/1339999435671-jpg.328/")
